    ...
    "definitions": {
        ...
        "domain.SessionCloseReason": {
            ...
            "x-enum-comments": {
                ...
                "SessionCloseMaxLifetime": "total lifetime exceeded the configured cap",
                "SessionCloseShutdown": "server shutting down"
            },
            "x-enum-descriptions": [
                "no activity within the configured idle window",
                "total lifetime exceeded the configured cap",
        ...
        "domain.StreamDVRConfig": {
            ...
            "properties": {
                ...
                "profiles": {
                    "description": "Profiles selects which renditions the CMAF blob archive records:\n\"\" or \"best\" = the best rendition only (default); \"all\" = every rendition\nin the ABR ladder.",
                    "type": "string"
                },
                "retention_sec": {
